...
public class SwaggerConfig {
	...
	public Docket postsApi() {
		return new Docket(DocumentationType.SWAGGER_2).groupName("rushmgmt-api").apiInfo(apiInfo()).select()
	...
	private ApiInfo apiInfo() {
		...
		return new ApiInfoBuilder().title("Rush Management Service").description("Rush Management Service API's")
